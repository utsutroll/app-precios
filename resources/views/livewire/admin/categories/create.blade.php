        ...
        <div>
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <input wire:model.defer="margin" type="number" min="1" class="appearance-none rounded-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-full focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Ingrese el MArgen de Ganancia (Opcional)">   
                </div>

                <div class="mb-4">
                    <label for="" class="sr-only">Tasa del Dolar</label>
                    <input wire:model.defer="tasa" type="number" min="1" class="appearance-none rounded-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-full focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Ingrese la Tasa del Dolar">   
                </div>
            </div>

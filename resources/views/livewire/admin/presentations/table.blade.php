                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{$p->name}} {{$p->medida}}</div>
                            </td>
                    ...
                    <tbody>
                        <tr class="text-center">
                            <td colspan="3" class="p-4">No hay un resultado para la busqueda "{{$search}}" </td>
                        </tr>     
                    </tbody>    
                    @else
                    <thead class="bg-gray-50">
                    ...
                    <tbody>
                        <tr class="text-center">
                            <td colspan="3" class="p-4">No se Encontraron Registros</td>
                        </tr>
                        @endif
                    </tbody>
                </table>

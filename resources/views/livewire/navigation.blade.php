                                ...
                                <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                    ...
                                    <a href="{{ route('admin.categories.index') }}" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Modulo para registar la categoría del producto.
                                            </p>
                                        </div>
                                    </a>
                                    ...
                                    <a href="{{ route('admin.presentations.index') }}" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Modulo para registar la Presentación del producto.
                                            </p>
                                        </div>
                                    </a>
                                ...
                                <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                    ...
                                    <a href="{{ route('margin-category') }}" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Modulo para actualizar el margen de ganancia según la categoría del producto.
                                            </p>
                                        </div>
                                    </a>
                                    <a href="{{ route('margin-brand') }}" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Modulo para actualizar el margen de ganancia según la Marca del producto.
                                            </p>
                                        </div>
                                    </a>
                                </div>
        ...
        <div class="py-6 px-5 space-y-6">
            ...
            <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                ...
                <div class="ml-4">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Generar un archivo PDF ó EXCEL con el listado de todos los Productos.
                    </p>
                </div>
            </a>
